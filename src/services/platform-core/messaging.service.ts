...
const retrieveInboxName =
  ...
  async (
    ...
    const resp = await fetch(
      `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/inboxes/${args.query.inboxId}`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${auth.authToken}`,
...
const registerDidwithInbox =
  ...
  async (
    ...
    const resp = await fetch(
      `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/inboxes/${args.body.did}`,
      {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${auth.authToken}`,
...
const listInboxDids =
  ...
  async (args?: ListInboxDidsArgs): Promise<ListInboxDidsReqResponse> => {
    ...
    switch (pagination) {
      case undefined:
        url = `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/inboxes/${args.query.inboxId}/dids`;
      default:
        const query = new URLSearchParams({
          limit: pagination.toString(),
          cursor: pagination.cursor,
        }).toString();
        url = `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/inboxes/${args.query.inboxId}/dids?${query}`;
    }
    const resp = await fetch(url, {
      method: 'GET',
      headers: {
...
const unregisterDidWithinInbox =
  ...
  async (args: UnregisterDidWithinInboxArgs): Promise<void> => {
    const resp = await fetch(
      `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/inboxes/${args.query.inboxId}/dids`,
      {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
...
const listInboxMessages =
  ...
  async (
    ...
    switch (pagination) {
      case undefined:
        url = `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/inboxes/${args.query.inboxId}/messages`;
      default:
        const query = new URLSearchParams({
          limit: pagination.limit.toString(),
          cursor: pagination.cursor,
        }).toString();
        url = `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/inboxes/${args.query.inboxId}/messages?${query}`;
    }
    const resp = await fetch(url, {
      method: 'GET',
      headers: {
...
const retrieveMessage =
  ...
  async (args: RetrieveMessageArgs): Promise<Message> => {
    const resp = await fetch(
      `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/inboxes/${args.query.inboxId}/messages/${args.query.messageId}`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${auth.authToken}`,
...
const signMessage =
  ...
  async (args: SignMessageArgs): Promise<string> => {
    const resp = await fetch(
      `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/sign`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
...
const verifyMessage =
  ...
  async (args: VerifyMessageArgs): Promise<VerifyMessageReqResponse> => {
    const resp = await fetch(
      `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/verify`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
...
const encryptMessage =
  ...
  async (args: EncryptMessageArgs): Promise<any> => {
    const resp = await fetch(
      `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/encrypt`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
...
const decryptMessage =
  ...
  async (args: DecryptMessageArgs): Promise<DecryptMessageReqResponse> => {
    const resp = await fetch(
      `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/decrypt`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
...
const sendMessage =
  ...
  async (args: SendMessageArgs): Promise<void> => {
    const resp = await fetch(
      `https://${auth.tenantUrl}.vii.mattr.global/core/v1/messaging/send`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
